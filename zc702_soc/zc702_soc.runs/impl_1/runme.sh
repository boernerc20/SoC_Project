...
HD_PWD='/home/boernerc20/zc702_soc/zc702_soc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log base_ps_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source base_ps_wrapper.tcl -notrace
