...
HD_PWD='/home/boernerc20/zc702_soc/zc702_soc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_ps_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_ps_wrapper.tcl
